...
class VideoCamera(object):
    ...
    def get_frame(self):
        ...
        ## path to the folder and mergered with haarcascade files
        ## but caffe model is used
        #path=__file__[0:-9]
        ...
        # the detector and recognized image text are integrated within the FaceClassNew python files
        #loop for multifaces
        #for(x,y,h,w) in face:
